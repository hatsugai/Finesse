...
opt fold_op2_ ## NAME ## _flonum(double acc, unsigned i, unsigned argc, const opt *argv) \
{                                                                                        \
    for ( ; i < argc; ++i) {                                                             \
		opt p = arg(i);                                                                  \
		double x;                                                                        \
...
opt fold_op2_ ## NAME ## _fixnum(int_t acc, unsigned i, unsigned argc, const opt *argv)  \
{                                                                                        \
    for ( ; i < argc; ++i) {                                                             \
		opt p = arg(i);                                                                  \
		if (is_fixnum(p)) {                                                              \
